<?php
/**
 * EventTrashBox Theme Customizer
 *
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'eventtrashbox_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'eventtrashbox_customize_partial_blogdescription',
			)
		);
	}
}
add_action( 'customize_register', 'eventtrashbox_customize_register' );
 ...
 * @return void
 */
function eventtrashbox_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function eventtrashbox_customize_partial_blogdescription() {
